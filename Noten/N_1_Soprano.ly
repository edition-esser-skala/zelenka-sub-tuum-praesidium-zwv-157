...
FirstSopranoNotes = {
	\relative c' {
		...
		g c2. b4
		a2 a b4( c d2~
		\tempoFirstEnd d cis) d1~ %40
		d\breve \bar "||"
		\time 4/4 \unset Staff.timeSignatureFraction \tempoFirstTuo g,2 b
		c4. es8 d c b g
		c2( b
		\stemDown a8[ d, d' c] \stemNeutral b2) %45
		a8 d4 d d d8~
		d( e4) d8 cis cis d[( c?]
		b4. c16[ b] a4. b16[ a]
		g2) a4 r
		...
		c4. es8 d c b g
		c2( b
		\stemDown a4 h c8[ g] \stemNeutral c4~
		c h) c r
		r8 f f es? d4. d8 %55
		es2 r
		r8 d c b a4( b~)
...
SecondSopranoNotes = {
	\relative c' {
		...
		r f^\solo es
		des4. des8 c4
		\mvTrr h2\fermata-\tweak DynamicText.X-offset #-2 -\f^\tutti r4
		r c^\soloE c %40
		des4. des8 c4
		\mvTrr f2\fermata-\tweak DynamicText.X-offset #-2 -\f^\tutti r4
		es4. d8 c b
		as4( c h8[ c]
		d4.) d8 c4~ %45
		c c( h)
		...
		d c( %110
		b as)
		g~ g\fermata-\tweak DynamicText.X-offset #-4 -\pp
		...
		d2.( c4 %120
		h c2 h4)
		c2~ c\fermata-\tweak DynamicText.X-offset #-2 -\p
		h\fermata-\tweak DynamicText.X-offset #-2 -\f r4 \tempoSecondTuoB c
...
FourthSopranoNotes = {
	\relative c' {
		...
		b g b4. b8 a4
		g2.( a4
		b8[ g] \once \stemUp b2 \once \tieDashed a4~) %20
...
SixthSopranoNotes = {
	\relative c' {
		...
		R
		R \bar "||"
		\time 3/2 \unset Staff.timeSignatureFraction es'2. es4 d2
		d d1 %25
		cis2 e e
		f1 e2
		d d e
