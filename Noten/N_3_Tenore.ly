...
SecondTenoreNotes = {
	\relative c' {
		...
		b4 as r
		R2.*2
		\mvTrr d2\fermata-\tweak DynamicText.X-offset #-2 -\fE^\tuttiE r4
		R2.*2 %41
		\mvTrr d2\fermata-\tweak DynamicText.X-offset #-2 -\fE^\tuttiE r4
		c d e8 e
		f[( c as c d es]
		...
		c b4. b8 as4~ %110
		as g8 c4 c8 d4
		d2~ d\fermata-\tweak DynamicText.X-offset #-4 -\pp
		...
		c4( h8[ d] es4 f~ %120
		f es d2)
		es~ es\fermata-\tweak DynamicText.X-offset #-2 -\pE
		d\fermata-\tweak DynamicText.X-offset #-2 -\f r4 \tempoSecondTuoB b
		as g \tempoSecondTuoFinis as2~\ffE
		as4(\pp g8[ f]) g2 \bar "|." %125 finis
	}
}
...
ThirdTenoreNotes = {
	\relative c' {
		...
		\tempoThirdInNecB h2.^\tuttiE h4 c d
		e2( a, f'
		h,2.) h4 a2~
		\tempoThirdInNecFinis a a( gis) %30
		a1. \bar "||"
		\tempoThirdSed c2 c c
		c2. c4 c2
		b( c) f,
...
SixthTenoreNotes = {
	\relative c' {
		...
		es es4 es es2 d
		R\breve \bar "||"
		\time 3/2 \unset Staff.timeSignatureFraction c2. c4 c2
		b h1 %25
		a2 cis cis
		d( a) cis
		d d b
		...
		d d r1
		\time 3/2 \unset Staff.timeSignatureFraction r2 \tempoSixthTuo d d
		b2. a4 g2
		c c f, %35
		c'1 c,2
		...
		e2 e r1
		\time 3/2 \unset Staff.timeSignatureFraction r2 \tempoSixthTuoC e e %45
		c2. h4 a2
		f' e dis
		e d? c
		d e1
...
TenthTenoreNotes = {
	\relative c' {
		...
		d a d2( cis4
		d8[ e f d] g[ f es d]
		c[ b16 a] g4_\critnote f8.[ e16] d8[ d']~ %40
